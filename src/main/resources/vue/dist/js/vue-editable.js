	...
	var VueEditable = {
		install: function(Vue) {
			Vue.prototype.$editable = function(e,callback) {
				...
				target.innerHTML = '<div class="el-input el-input--mini"><input id="_editable" value="' + value + '" style="color:red;box-sizing:border-box;background:transparent;" type="text" autocomplete="off" class="el-input__inner"></div>';
				//target.innerHTML = "<input type='text' value='" + value + "'  style='width:100%;box-sizing:border-box;background:transparent;font-size:13px;color:red;text-align:center'>";
